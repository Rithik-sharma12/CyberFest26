google.maps.__gjsload__('search', function(_) {
    var fxa = function(a) {
        ...
        exa = function(a) {
            ...
            const d = [];
            a.Rv().forEach(e => {
                e.a && e.a.length >= 2 && d.push(new gxa(e, b, c))
            });
            return d
        },
        hxa = class extends _.Wn {};
    var ixa = {
            ["1"]: {}
        },
        gxa = class {
            ...
            getAnchor() {
                if (!this.anchor) {
                    const a = 1 << this.zoom;
                    this.anchor = _.Nr(new _.ar((this.Ao.x * 256 + this.source.a[0]) / a, (this.Ao.y * 256 + this.source.a[1]) / a)).toJSON()
                }
                return this.anchor
            }
            getCompleteBounds() {
                    ...
                    if (!jxa.has(a)) {
                        ...
                        var c = [],
                            ...
                            e = () => {
                                ...
                                b.forEach(f => {
                                    if (f = f.data) c.push(_.Dn(f, "insert", g => {
                                        d(g, "addfeatures")
                                    })), c.push(_.Dn(f, "remove", g => {
                                        d(g, "removefeatures")
                                    }))
                                })
                            };
